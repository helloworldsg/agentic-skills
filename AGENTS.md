...
- When doing bug fixes, always start with reproducing the bug in an E2E setting as closely aligned with how an end user would experience it as much as possible . This makes sure you find the real problem so your fix will actually solve it.
